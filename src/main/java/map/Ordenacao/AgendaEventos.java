...
import main.java.map.Ordenacao.Evento;
...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2024, 10, 10), "Seminário de Inteligência Artificial", "Discussão sobre IA avançada");
